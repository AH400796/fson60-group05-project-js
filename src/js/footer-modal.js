...
<li class="team-card">
<div class="image-bg">
 <img src="${andrUrl}" alt="Andria" loading="lazy" class="team-image"></div>
    <p class="team-name">Андрій Гохман</p>
    <p class="team-role">Team Lead</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${uraaUrl}" alt="Yuriy" loading="lazy" class="team-image"></div>
    <p class="team-name">Юрій Кириченко</p>
    <p class="team-role">Scrum Master</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${antoniaUrl}" alt="Anton" loading="lazy" class="team-image"></div>
    <p class="team-name">Антон Кошевой</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${dansUrl}" alt="Danilo" loading="lazy" class="team-image"></div>
    <p class="team-name">Данило Бандура</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${darrUrl}" alt="Darina" loading="lazy" class="team-image"></div>
    <p class="team-name">Дарина Пільганчук</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${daniyaUrl}" alt="Daniil" loading="lazy" class="team-image"></div>
    <p class="team-name">Данііл Козлов</p>
    <p class="team-role">Developer</p>
    </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${oksrUrl}" alt="Oksana" loading="lazy" class="team-image"></div>
    <p class="team-name">Оксана Захарія</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${uriyUrl}" alt="Yuriy" loading="lazy" class="team-image"></div>
    <p class="team-name">Юрій Петренко</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${olexandrUrl}" alt="Alex" loading="lazy" class="team-image"></div>
    <p class="team-name">Олексій Самохін</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${irunUrl}" alt="Iruna" loading="lazy" class="team-image"></div>
    <p class="team-name">Ірина Крикун</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${olgaUrl}" alt="Olga" loading="lazy" class="team-image"></div>
    <p class="team-name">Ольга Конотоп</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${serhUrl}" alt="Sergii" loading="lazy" class="team-image"></div>
    <p class="team-name">Сергій Яценко</p>
    <p class="team-role">Developer</p>
  </li>
  <li class="team-card">
  <div class="image-bg">
    <img src="${svitlanaUrl}" alt="Svitlana" loading="lazy" class="team-image"></div>
  ...
  <li class="team-card">
  <div class="image-bg">
    <img src="${ihorUrl}" alt="Ihor" loading="lazy" class="team-image"></div>
